-- Mohammad Sepehr
-- This is a short project using SQL on data related to Covid-19 gathered 
-- over the period of 2 years around the world. The sole purpose of this project
-- was to show my abilities to use simple SQL queries and extract the desired subset of the data
-- from the large set of data in hand. There is a LOT more that can be done with this dataset. 
